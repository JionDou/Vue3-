<template>
  ...
  import LayoutSideBar from './SideBar/SideBar.vue'
  import LayoutNavBar from './NavBar/NavBar.vue'
  import LayoutTabsBar from './TabsBar/TabsBar.vue'
  import ThemeDrawer from './NavBar/components/ThemeDrawer.vue'
